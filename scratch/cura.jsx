    ...
    <div className="desktop2">
      ...
      <section className="curaai-web-app-ui-design2">
        ...
        <section className="app4">
          <div className="container13">
            <div className="container14">
              <img className="asset-5-12" alt="" src="/Asset-5-1@2x.png" />

              <img
                className="asset-4-12"
                loading="lazy"
                alt=""
                src="/Asset-4-1@2x.png"
              />

              <div className="heading-14"></div>
            </div>
            <nav className="container15">
              <div className="button14">
                <div className="home2">Home</div>
              </div>
              <div className="button15">
                <div className="simulation2">Simulation</div>
              </div>
